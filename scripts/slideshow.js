  ...
  function multiSlideShow() {
    ...
    this.createTransitionEffect = function () {
      ...
      for (let i = 0; i < options.contents.length; i++) {
        ...
        transitionItem.classList.add('transitionItem');
        if (i == 0) transitionItem.style.marginLeft = '15%';
        if (i == options.contents.length - 1) transitionItem.style.marginRight = '15%';
      ...
      slideShow.appendChild(transitionContainer);

      this.addButton(slideShow, prev, next, dotContainer);
