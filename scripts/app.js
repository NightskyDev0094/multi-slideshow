...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  console.log(document.querySelector('.effectItem').querySelector('.checkEffectIcon'));
...
function getSlideEffectOffect() {
  if (options.effectType == 'transition') {
    ...
    document.querySelector('#displayDuration').parentElement.parentElement.style.display = 'block';
    document.querySelector('#backgroundOption').style.display = 'block';
    document.querySelector('#backgroundDuration').parentElement.parentElement.style.display = 'block';
    document.querySelector('#backgroundDelay').parentElement.parentElement.style.display = 'block';
    document.querySelector('#captainDuration').parentElement.parentElement.style.display = 'block';
    document.querySelector('#captainDelay').parentElement.parentElement.style.display = 'block';
    document.querySelector('#descriptionDuration').parentElement.parentElement.style.display = 'block';
    document.querySelector('#descriptionDelay').parentElement.parentElement.style.display = 'block';
  }
