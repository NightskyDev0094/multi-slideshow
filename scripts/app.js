...
document.addEventListener("DOMContentLoaded", function(e) {
  ...
  console.log(
    document.querySelector(".effectItem").querySelector(".checkEffectIcon")
  );
  document
    .querySelector(".effectItem")
    .querySelector(".checkEffectIcon").style.display = "block";
  createContentList();
...
function transitionEffect() {
  document.querySelector(".transitionPanel").style.transform =
    "translateX(-60%)";
  setTimeout(() => {
    document.querySelectorAll(".transitionImageItem")[1].style.transform =
      "scale(1)";
  }, 1100);
  document
    .querySelector(".transitionPanel")
    .animate({ transform: ["translateX(0px)", "translateX(-60%)"] }, 1000);
